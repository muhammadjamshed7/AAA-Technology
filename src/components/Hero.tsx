...
export default function Hero() {
  return (
    <main className="bg-white">
      <section className="relative bg-white bg-[url('https://images.pexels.com/photos/7547027/pexels-photo-7547027.jpeg')] bg-cover bg-center">
  <div className="absolute  bg-gray-100 w-[100%] h-[100%] opacity-70"></div>
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
    <div className="text-center">
      ...
      <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
        We craft exceptional digital experiences and drive growth through
        innovative solutions in web development, mobile apps, and digital
        marketing.
      </p>
