...
const projects = [
  {
    ...
    description:
      "Custom B2B marketplace with advanced filtering and real-time inventory management",
    image:
  ...
  },
  {
    ...
    description:
      "Integrated marketing campaign that increased client ROI by 300%",
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80",
  },
];
...
export default function FeaturedWork() {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-green-50 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto italic">
              "Our mission is to deliver innovative, client-centric solutions
              that fuel business growth. We are committed to providing
              exceptional value, ensuring that our clients achieve long-term
